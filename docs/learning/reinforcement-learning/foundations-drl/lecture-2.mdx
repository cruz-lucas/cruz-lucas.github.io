...
<aside>
💡 Expectations can be approximated with samples. In practical situations, we might not have the exact expectation because the transition matrix is unknown.
